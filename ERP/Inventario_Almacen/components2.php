...
<ul id="dropdown1" class="dropdown-content">
  <li><a href="pages/almacen.php" target="_blank">Ingreso de datos para almacen</a></li>
  <li class="divider"></li>
  <li><a href="pages/demo.php">Formato de rechazo</a></li>
  <li class="divider"></li>
  <li><a href="pages/formato de requisicion.pdf" target="_blank">Formato de requisición</a></li>
  <li class="divider"></li>
  <li><a href="pages/demo.php" target="_blank">Etiquetado</a></li>
  <li class="divider"></li>
...
<div class="nav-wrapper light-blue darken-4">
  <a href="#!" class="brand-logo right">Almacén <img class="circle responsive-img" src="../img/01.jpg" width="40" height="40"></a>
