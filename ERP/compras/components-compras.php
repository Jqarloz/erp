...
<ul id="dropdown1" class="dropdown-content">
  <li><a href="pages/consulta-pedidos.php">Compras</a></li>
  <li class="divider"></li>
  <li><a href="pages/consulta-proveedores.php">Proveedores</a></li>
  <li class="divider"></li>
  <li><a href="pages/consulta-materiaprima.php">Materia Prima</a></li>
</ul>
<div class="navbar-fixed">
<nav>
<div class="nav-wrapper teal darken-3">
  <a href="#" class="brand-logo right">Compras <img class="circle responsive-img" src="../img/03.jpg" width="40" height="40"></a>
