...
while($resultados=mysqli_fetch_array($consulta_empleado)){
  ...
  echo '<table align="center" border="0" width="550">';
   ...
   /* echo "<a href='ReporteEmpleado.php?codemp=$resultados[idEmpleado]'>Imprimir Pago</a>";*/
    ...
    echo "<a href='ReporteEmpleado.php?codemp=$resultados[idEmpleado]&fechai=$resultados[FechaEmpInicial]&fechaf=$resultados[FechaEmpFinal]'><button type='button'>Imprimir Pago</button></a>&nbsp;&nbsp;&nbsp;";
    
    echo "<a href='VisualizarPagoEmpleado.php'><button type='button'>Cancelar</button></a>";
