<?php
    ...
    if (!empty($_POST)) {
        ...
        $sql = "SELECT idClientes from clientes where usuario='$usuario' and password='$sha1_pass'";
...
<body class="font-cover" id="login">
    ...
    <li class="tab col s3"><a href="login.php">Soy Cliente</a></li>
    <li class="tab col s3"><a class="active" href="#Empleado">Soy Empleado</a></li>
    </ul>
  ...
  <div id="Empleado" class="col s12">
    <div class="container-login center-align">
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <input type="submit" name="login" value="Iniciar Sesión " class="waves-effect waves-teal btn-flat" >
        </form>
